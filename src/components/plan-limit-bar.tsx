...
const PlanLimitBar = ({ uploaded = 6, max = 10 }) => {
  ...
  return (
    <div className="md:ml-[350px] bg-mystic-800 fixed bottom-0 md:border-0 border-t border-t-mystic-600 shadow-2xl md:shadow-none md:border-t-mystic-800 left-0 right-0 py-2 px-4 md:px-8 space-y-2">
