...
export function SignupEmailTemplate({
  email,
  otp,
  expiryMinutes = 10,
    ...
    <html>
      ...
      <body className="container">
        <div className="card">
          ...
          <p className="lead">
            Welcome to Mythoria! Verify your email to start your adventure
          </p>
          ...
          <p className="muted">
            You signed up with{" "}
            <strong style={{ color: "white" }}>{email}</strong>. Enter the
            one-time code below to verify your account. This code expires in{" "}
